...
var Menu = class ArcMenu_RedmondLayout extends BaseMenuLayout{
    static {
    ...
    constructor(menuButton) {
        ...
        horizontalFlip ? this.rightBox.style += "margin-right: 0px" : this.rightBox.style += "margin-left: 0px";
        ...
        if(defaultMenuView === Constants.DefaultMenuViewRedmond.PINNED_APPS){
            ...
            this._viewAllAppsButton = this._createNavigationRow(_("Pinned"), Constants.Direction.GO_NEXT, _("All Apps"), () => this.displayAllApps());
        }
            ...
            this._viewAllAppsButton = this._createNavigationRow(_("All Apps"), Constants.Direction.GO_NEXT, _("Pinned"), () => this.displayPinnedApps());
        }
