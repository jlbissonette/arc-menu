...
var Menu = class ArcMenu_UnityLayout extends BaseMenuLayout{
    static {
    ...
    loadCategories() {
        ...
        const categoryMenuItem = new MW.CategoryMenuItem(this, Constants.CategoryType.HOME_SCREEN, Constants.DisplayType.LIST);
