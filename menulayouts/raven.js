...
var Menu = class ArcMenu_RavenLayout extends BaseMenuLayout{
    static {
    ...
    updateLocation(){
        ...
        const positionX = ravenPosition === Constants.RavenPosition.LEFT ? monitorWorkArea.x : monitorWorkArea.x + monitorWorkArea.width - 1;
        const positionY = this.arcMenu._arrowSide === St.Side.BOTTOM ? monitorWorkArea.y + monitorWorkArea.height : monitorWorkArea.y;
        ...
        const style = '-arrow-base: 0px; -arrow-rise: 0px; -boxpointer-gap: 0px; -arrow-border-radius: 0px; margin: 0px;';
    ...
    loadCategories() {
        ...
        for(let i = 0; i < extraCategories.length; i++){
            ...
            const categoryMenuItem = new MW.CategoryMenuItem(this, categoryEnum, Constants.DisplayType.BUTTON);
