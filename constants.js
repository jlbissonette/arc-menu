...
var DistroIcons = [
    ...
    { PATH: DistroIconsPath + 'debian-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'fedora-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'manjaro-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'pop-os-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'ubuntu-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'arch-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'opensuse-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'raspbian-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'kali-linux-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'pureos-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'solus-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'budgie-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'gentoo-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'mx-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'redhat-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'voyager-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'zorin-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'endeavour-logo-symbolic.svg'},
    { PATH: DistroIconsPath + 'nobara-logo-symbolic.svg'},
]
